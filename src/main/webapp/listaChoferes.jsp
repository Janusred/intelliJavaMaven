...
<%@page import="com.carmona.app.rutas.models.*" %>

<%
//recuperamos la lista de choferes que seteamos en el request desde el serlet
        ...
        <div class="row">
            <div class="col-12">
                <div class="table-responsive">
                    <table class="table table table-bordered table-striped" id="tablaChoferes" width="100%" cellspacing="0">
                        <thead>
                            <tr>

                            <div class="th">Id</div>
                            <div class="th">Nombre</div>
                            <div class="th">Ap. Paterno</div>
                            <div class="th">Ap. Materno</div>
                            <div class="th">Licencia</div>
